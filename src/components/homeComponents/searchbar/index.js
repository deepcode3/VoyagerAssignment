		...
		<>
			<div className="searchCard">
				<div className={from === 'home' ? 'searchBox' : 'restaurantSearchBox'}>
					<input
						className={
							from === 'home' ? 'searchInput' : 'restaurantSearchInput'
						}
						type="text"
					...
					{searchKey || searchValue ? (
						<img
							...
							src={clearButton}
							className={
								from === 'home' ? 'clearButton' : 'restaurantclearButton'
							}
							onClick={() => {
								setSearchKey('');
							}}
...
export const LocationSetter = ({ locationValue, from }) => {
	...
	return (
		<div
			className={
				from === 'home' ? 'locationSetter' : 'restaurantLocationSetter'
			}
		>
			<input
				className={
					from === 'home' ? 'locationInput' : 'restaurantLocationInput'
				}
				onChange={(e) => {
